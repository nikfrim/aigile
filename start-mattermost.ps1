...
docker compose -p mattermost-app -f $ComposeFile -f $NetworkFile --env-file $EnvFile up -d --pull if_not_present

Write-Host ""
Write-Host "Mattermost is starting at http://localhost:8065"
